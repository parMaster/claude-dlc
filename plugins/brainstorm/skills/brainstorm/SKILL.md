...
allowed-tools: Read, Write, Glob, Grep, Bash, Agent, AskUserQuestion, EnterPlanMode
---
...
- **Write plan**: create `docs/plans/YYYYMMDD-<task-name>.md` with implementation steps. Include discovered files, selected approach, and design decisions so nothing needs re-asking.
