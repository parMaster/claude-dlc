...
flowchart TD
    ...
    H -->|"all iterations done"| W{"housekeeping needed?"}
    W -->|"yes"| X["do housekeeping"]
    X --> W
    W -->|"no"| Y["final progress log entry + move WBS to completed/"]
    Y --> DONE(["epic closed out"])
```
